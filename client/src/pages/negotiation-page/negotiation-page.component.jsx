...
const headlines = [
    ...
    "Do your research so you know what you must have (minimum), want to get (target), nice to get (aspirational goal).  Know the market rate for the type of position in that industry in that geographic region.",
